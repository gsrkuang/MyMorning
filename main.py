...
def get_weather():
  ...
  return weather['weather'], math.floor(weather['low']),math.floor(weather['high']),weather['airQuality'],weather['wind']
...
wea, temperature_hight,temperature_low,airQuality,wind = get_weather()
